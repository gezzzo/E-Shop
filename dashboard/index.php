                                ...
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <th> <img src="images/<?= $category["thumbnail"] ?>" alt="" srcset="" height="150px"></th>
                                            <th><a href="updatecategory.php?id=<?= $category["id"] ?>" class="btn btn-secondary" style="color: white">Update</a> </th>
                                            <th><a href="deletecategory.php?id=<?= $category["id"] ?>" class="btn btn-danger" style="color: white">Delete</a> </th>
                                        </tr>
                                        <?php endforeach; ?>
                                    </tbody>
                                </table>
