...
if (isset($_POST['Name'])) {
    ...
    if (empty($errors)) {
        AddProduct($sku,$name,$description,$price,$img,$thumbnail,$stock,$category_id,$_SESSION["admin"]["id"]);
                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <form action="addproduct.php" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-floating mb-3">
                                <input class="form-control" id="inputSku" type="text" placeholder="Sku" name="Sku"/>
                            ...
                            <div class="form-floating mb-3">
                                <input class="form-control" id="inputPrice" type="number" placeholder="Price" name="Price"/>
                                <label for="inputPrice">Price</label>
                            </div>
                            <div class="form-floating mb-3">
                                <input class="form-control" id="inputStock" type="number" placeholder="Stock" name="Stock"/>
