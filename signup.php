...
if (isset($_POST["email"])) {
    ...
    if (empty($_POST["country"])){
        $errors[]="The country is required";
    }
    ...
    if (empty($errors)){
        ...
        if (AddCustomer($name,$email,$password,$country,$phone,$address)) {
                ...
                <main>
                    <div class="container">
                        <div class="row justify-content-center">
                            <div class="col-lg-5">
                            <a href="index.php"><h3 class="text-center font-weight-light my-4" style="color:White">Eshop</h3></a>
                                ...
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <div class="card-body">
                                        <form action="signup.php" method="post">
                                            ...
                                            <div class="form-floating mb-3">
                                                <input class="form-control" id="inputAddress" type="text" name="country" />
